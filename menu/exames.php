...
<body>
    ...
    <main>
      ...
      <section class="image-container w-100 object-fit-xxl-contain pezinho-imagem" style="height: 50vw; background-image: url(../img/exames/fundo.jpg);">
        <div class="text-container pezinho-texto" style=" top: 35vw;text-shadow: 2px 4px 2px #00000077;">
            ...
            <h1 style="color:#ffffff !important; font-weight: 500;" class="texto-titulo">Resultados de <br> Exames</h1>
        </div>
        ...
        <section class="container-fluid p-5">
          <div class="col">
            ...
            <div class="row p-5">
              <h2 class="texto-titulo " style="color: #075e3e;">Você está buscando por resultados de:</h2>
            ...
            <div class="position-relative">
              <p class="texto texto-preto position-absolute" style="font-size: 1.1em;">Resultados de exames <br>laboratoriais</p>
              <button class="btn btn-success botao-planos position-absolute" style="background-color: #59AA8C; padding: 1.3vw; font-size: 10pt; font-family: 'Montserrat';font-weight: 600; letter-spacing: 0.9pt; border-radius: 8px; max-width: 150px;border: none; right: 0;">Resultado</button>
              </div>
            ...
            <div class="row p-5">
              ...
              <div class="position-relative">
              <p class="texto texto-preto position-absolute" style="font-size: 1.1em;">Resultados do <br>teste do pezinho</p>
              <button class="btn btn-success botao-planos position-absolute" style="background-color: #59AA8C; padding: 1.3vw; font-size: 10pt; font-family: 'Montserrat';font-weight: 600; letter-spacing: 0.9pt; border-radius: 8px; max-width: 150px;border: none; right: 0;">Resultado</button>
              </div>
            ...
            <div class="position-relative">
              <p class="texto texto-preto position-absolute" style="font-size: 1.1em;">Gravações do Exame <br>de Ultrassom</p>
              <button class="btn btn-success botao-planos position-absolute" style="background-color: #59AA8C; padding: 1.3vw; font-size: 10pt; font-family: 'Montserrat';font-weight: 600; letter-spacing: 0.9pt; border-radius: 8px; max-width: 150px;border: none; right: 0;">Resultado</button>
              </div>
        ...
        <div class="col-3">
            ...
            <div class="col-3">
              <a href="exames.php">
                <img src="../img/Botoes_abas/botoes_abas_selecao/Exame.png" alt="" >
              </a>
            </div>
            <div class="col-3">
              <a href="visitas.php">
