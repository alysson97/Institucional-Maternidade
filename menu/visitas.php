...
<body>
    ...
    <main>
      ...
      <section class="image-container w-100 object-fit-xxl-contain pezinho-imagem" style="height: 50vw; background-image: url(../img/visita/fundo.jpg);">
        <div class="text-container pezinho-texto" style=" top: 35vw;text-shadow: 2px 4px 2px #00000077;">
            ...
            <h1 style="color:#ffffff !important; font-weight: 500;" class="texto-titulo">Agendamento <br>de Visitas</h1>
        </div>
      ...
      <section class="container-fluid">
        ...
        <div class="row p-5">
          <div class="col">
            <div class="row">
              <h3 class="d-inline texto-titulo texto-preto" style="color: #075e3e;"><img src="../img/icon/visita-icon.png" alt=""><span>Visita presencial</span></h3>
            </div>
          </div>
          <div class="col">
            <div class="row">
              <p class="texto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat blanditiis, ab, pariatur dolores enim quae a molestias amet, nisi sit quas dolor mollitia ipsa et esse est repellat nulla veritatis!</p>
            </div>
            <div class="row position-relative mb-5">
            <button class="btn btn-success botao-planos position-absolute" style="background-color: #59AA8C; padding: 1.3vw; font-size: 10pt; font-family: 'Montserrat';font-weight: 600; letter-spacing: 0.9pt; border-radius: 8px; max-width: 150px;border: none; right: 0;">Agendar Visita</button>
            </div>
        ...
        <div class="row p-5">
          ...
          <div class="col">
            <div class="row">
              <h3 class="d-inline texto-titulo texto-preto" style="color: #075e3e;"><img src="../img/icon/visita-icon.png" alt=""><span>Visita virtual</span></h3>
            </div>
          </div>
        ...
        <div class="col-3">
              <a href="consultas.php">
                <img src="../img/Botoes_abas/Consulta.png" alt="" >
              </a>
            </div>
            <div class="col-3">
              <a href="exames.php">
            ...
            <div class="col-3">
              <a href="visitas.php">
                <img src="../img/Botoes_abas/botoes_abas_selecao/Visita.png" alt="" >
              </a>
            </div>
          </div>
